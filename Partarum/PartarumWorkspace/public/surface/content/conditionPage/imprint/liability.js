...
export default {
    content: {
        p_1:    `Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG
        ...
        p_2:    `Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen
    ...
    link: {
        p_1:    `Unser Angebot enthält Links zu externen Websites Dritter,
        ...
        p_2:    `Eine permanente inhaltliche Kontrolle der verlinkten Seiten
